...
jalan('\033[1;92m   ......................... daking72.........................:')

jalan("\033[1;93m   тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд Welcome to daking72тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд   ")

jalan('\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИLogin New AcountтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ  ')

jalan('\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИ CP Acount Open After 4hour Days тФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ  ')

jalan("\033[1;93m тШЮ тФИтФИFrends Cloning with Nigeria link nd others├и karainтФИ ")

jalan("\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИтФИWhatsApp Num :  +2348065623271тФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ")
...
CorrectUsername = "nigerian"

CorrectPassword = "bothacker"
